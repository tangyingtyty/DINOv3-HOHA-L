...
SAM_WEIGHTS = {
    # Pretrained models
    'sam_vit_b': '/segment-anything/checkpoints/sam_vit_b_01ec64.pth',
    'sam_vit_l': '/segment-anything/checkpoints/sam_vit_l_0b3195.pth',
    'sam_vit_h': '/segment-anything/checkpoints/sam_vit_h_4b8939.pth',
}

BACKBONE_INTERMEDIATE_LAYERS = {
    "sam_vit_b": [2, 5, 8, 11],
    "sam_vit_l": [5, 11, 17, 23],
    "sam_vit_h": [7, 15, 23, 31],
}
...
class SAM_Segmentation(nn.Module):
    def __init__(self, *, backbone_name="sam_vit_b", num_classes=8):
        super().__init__()

        model = sam_model_registry[backbone_name[-5:]](checkpoint=SAM_WEIGHTS.get(backbone_name))
        ...
        embed_dim = BACKBONE_EMBED_DIM[backbone_name]
...
if __name__ == "__main__":
    model = SAM_Segmentation(backbone_name="sam_vit_h", num_classes=8)

...
BACKBONE_INTERMEDIATE_LAYERS = {
    "vit_huge_patch14_224.mae": [7, 15, 23, 31],
    "vit_huge_patch14_clip_224.laion2b": [7, 15, 23, 31],
}
...
class TIMM_Segmentation(nn.Module):
    def __init__(self, *, backbone_name="vit_huge_patch14_224.mae", num_classes=8):
        super().__init__()
        ...
        embed_dim = self.encoder.feature_info.channels()[-1]
...
if __name__ == "__main__":
    model = TIMM_Segmentation(backbone_name="vit_huge_patch14_224.mae", num_classes=8)
